document.addEventListener("DOMContentLoaded", () => {
    ...
    for(let i = 1; i <= 10; i++){
        ...
        const position = cardPosition[i - 1];
    ...
    ScrollTrigger.create({
        ...
        onUpdate: (self) => {
            ...
            document.querySelectorAll(".title").forEach((titlesContainer, index) => {
                const title1 = titlesContainer.querySelectorAll(".title-1");
                const title2 = titlesContainer.querySelectorAll(".title-2");
                const title3 = titlesContainer.querySelectorAll(".title-3");
